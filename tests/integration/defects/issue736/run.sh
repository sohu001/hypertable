...
cp ${HYPERTABLE_HOME}/conf/recovery-hook.sh recovery-hook.bak
cp ${SCRIPT_DIR}/recovery-hook.sh ${HYPERTABLE_HOME}/conf/recovery-hook.sh
...
then
  ...
  mv recovery-hook.bak ${HYPERTABLE_HOME}/conf/recovery-hook.sh
  exit 1
fi
