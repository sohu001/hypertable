...
[ "$TEST_2" ] && run_test1 2 "--induce-failure=recover-server-ranges-root-4:exit:0"
...
[ "$TEST_7" ] && run_test1 7 "--induce-failure=recover-server-ranges-metadata-4:exit:0"
...
[ "$TEST_12" ] && run_test1 12 "--induce-failure=recover-server-ranges-user-4:exit:0"
...
[ "$TEST_24" ] && run_test2 24 "--induce-failure=recover-server-ranges-user-3:exit:0" "--induce-failure=replay-fragments-1:exit:0"
[ "$TEST_25" ] && run_test2 25 "--induce-failure=recover-server-ranges-user-3:exit:0" "--induce-failure=phantom-receive-1:exit:0"
[ "$TEST_26" ] && run_test2 26 "--induce-failure=recover-server-ranges-user-3:exit:0" "--induce-failure=phantom-receive-2:exit:0"
...
[ "$TEST_43" ] && run_test4 43 "--induce-failure=recover-server-ranges-root-4:exit:0"
[ "$TEST_44" ] && run_test4 44 "--induce-failure=recover-server-ranges-user-4:exit:0"
...
[ "$TEST_50" ] && run_test2 50 "--induce-failure=recover-server-ranges-user-3:exit:0" "--induce-failure=phantom-receive-1:exit:0"
