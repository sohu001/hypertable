...
namespace Hypertable {
  ...
  class RequestHandlerPhantomReceive : public ApplicationHandler {
  public:
    RequestHandlerPhantomReceive(Comm *comm, RangeServer *rs, EventPtr &event_ptr)
...
#endif // HYPERTABLE_REQUESTHANDLERPHANTOMRECEIVE_H
